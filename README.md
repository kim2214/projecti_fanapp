...
- 방송 제목·카테고리·시청자 수·방송 경과 시간과 **방송 썸네일**을 표시하고, 카드를 누르면 치지직 방송으로 이동합니다.
...
- SNS 바로가기(X/Twitter, YouTube)와 치지직(Chzzk) 라이브 채널 바로가기를 제공합니다. 네이버 카페·디스코드 링크는 등록된 멤버에게만 표시됩니다.
